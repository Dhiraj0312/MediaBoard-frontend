...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-neutral-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-section">
        <div className="text-center">
          <div className="mx-auto h-14 w-14 flex items-center justify-center rounded-xl bg-primary-50 shadow-sm">
            <svg className="h-7 w-7 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <h1 className="heading-secondary mt-6">
