    ...
    <DashboardLayout>
      <div className="container-responsive space-page">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 sm:gap-0">
          <div>
            <h1 className="heading-secondary">Screens</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={refresh}
              disabled={isLoading}
              className="inline-flex items-center px-4 h-10 border border-neutral-300 shadow-sm text-sm font-medium rounded-lg text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus-visible:ring-4 focus-visible:ring-primary-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-150"
            >
